...
function generateAssetFileName(name, source, originalFileName, sourceHash, outputOptions, bundle) {
  ...
  return makeUnique(renderNamePattern(typeof outputOptions.assetFileNames === "function" ? outputOptions.assetFileNames({ name, originalFileName, source, type: "asset" }) : outputOptions.assetFileNames, "output.assetFileNames", {
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-RVC3CBSJ.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-QCETC4QD.js.map
